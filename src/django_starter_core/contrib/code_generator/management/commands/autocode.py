...
from django_starter_core.contrib.code_generator.analyzer import get_app
from django_starter_core.contrib.code_generator.generator import Generator
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        generator = Generator(
            ...
            template_path=str(Path(__file__).resolve().parents[2] / "templates")
        )
