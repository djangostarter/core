...
def index(request):
    ...
    return render(request, 'django_starter_core/about/index.html', context)
...
def partials_milestones(request):
    ...
    return render(request, 'django_starter_core/about/partials/milestones.html', context)
...
def partials_team(request):
    ...
    return render(request, 'django_starter_core/about/partials/team.html', context)
...
def partials_faq(request):
    ...
    return render(request, 'django_starter_core/about/partials/faq.html', context)
...
def contact(request):
    ...
    template_name = 'django_starter_core/about/contact.html'
    context = {
...
def privacy_policy(request):
    """渲染隐私政策页面。"""
    return render(request, 'django_starter_core/about/privacy_policy.html')


def terms_of_service(request):
    """渲染服务条款页面。"""
    return render(request, 'django_starter_core/about/terms_of_service.html')
