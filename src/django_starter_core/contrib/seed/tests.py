...
from django_starter_core.contrib.about.models import About, Contact
from django.apps import apps
from django_starter_core.contrib.seed.seeder import Seeder
...
class TestSeedCommand:
    def test_seed_contact(self):
        ...
        # 确认 app label
        app_config = apps.get_app_config('django_starter_core_about')
        assert app_config.name == 'django_starter_core.contrib.about'

        call_command('seed', 'django_starter_core_about', count_to_seed)
