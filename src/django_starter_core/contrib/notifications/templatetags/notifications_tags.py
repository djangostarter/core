...
from django_starter_core.contrib.notifications.models import Notification

register = template.Library()


@register.inclusion_tag("django_starter_core/notifications/_dropdown.html", takes_context=True)
